...
DATA = importdata('data-by-day_20201210.csv');
data = DATA.data;
ndays = 10; %%% Keeping the last 10 days for forecast.
...
PropICU = 0.4;
PropDeath = 0.4*sum(data1(:,4))/sum(data1(:,3));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Initial parameters
...
Death(3:end) = min(1,data1(2:end,4)./data1(1:end-1,3))/Death_I;
...
hold off
saveas(gcf,'InfectionsNYCAS.fig');
print('-dpng','InfectionsNYCAS');
...
bar(t_span(2:end),data1(:,4),'FaceColor',[0 0.75 0.75],'EdgeColor','none')
...
set(gca,'FontSize',16,'FontName','Arial')
hold off
saveas(gcf,'DeathsNYCAS.fig');
print('-dpng','DeathsNYCAS');
...
set(gca,'FontSize',16,'FontName','Arial')
hold off
saveas(gcf,'HospNYCAS.fig');
print('-dpng','HospNYCAS');
...
set(gca,'FontSize',16,'FontName','Arial')
hold off
saveas(gcf,'R0NYC_smooth.fig');
print('-dpng','R0NYC_smooth');
