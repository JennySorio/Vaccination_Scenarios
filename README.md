...
To meet the first objective, we must use the files that start with the name **Bootstraping** and **mySEIR**, which, in addition to estimated the predictions, estimates all the parameters associated with the model.
