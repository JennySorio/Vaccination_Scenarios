...
The functions that start with **ObjFun** are those related to the generation of the vector beta. For this, are estimated  mildly infective population  and b ; after the vector beta  is calibrated. 
